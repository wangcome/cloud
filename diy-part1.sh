...
echo 'src-git pl https://github.com/xiaorouji/openwrt-passwall.git;luci' >>feeds.conf.default
echo 'src-git sl https://github.com/pymumu/luci-app-smartdns.git' >>feeds.conf.default
